...
#AEAD CHACHA20-POLY1303 - 2600hacker edition
...
import math
#AEAD CHACHA20-POLY1303
import binascii, pysodium
key1 = 'XOpthNAHyQuqGAS32Vchi38F2VmrUNCs9ustYVS23qx36kmhB70Ui+qYG2HrsX9znuGjO3IaVEhv0w1ekz23OZ2mf2o104AdmiJJwNJeUCHR'
key2 = 'rgCWuoy4T7VwEhE9HEWNqTMNn5JsNPARM7fwnKOKMUa9ff0D5EyeutCNy4v17RdvinzJM5UBJv3OWEl7DuFhDNgcGEHIzkdTrNXhjXqY8Y17'
key3 = 'GScWEhMWcRyQcp2M16ogxm16NgtZtVLFOMay57OKePxgPPfRXrNt2GA0XhnP+TmizMAlqum+lrsTQ4gtPExKBcyakIQsB5DKilivwHnurzLG'
...
def send(channel, marionette_state, input_args, blocking=True):
   ...
   #change scrypt against streamcipher    
#        ptxt = scrypt.encrypt(ptxt, password, maxtime=0.1)
...
#--->
        ...
        key4 = binascii.unhexlify(key3)
        ptxt = pysodium.crypto_aead_chacha20poly1305_encrypt(ptxt, key2, key3, key1)
...
def recv(channel, marionette_state, input_args, blocking=True):
    ...
    try:
        ...
        if len(ctxt) > 0:
            ...
            ctxt = b64decode(ctxt)
#decrypt stream --->
            ctxt = pysodium.crypto_aead_chacha20poly1305_decrypt(ptxt, key2, key3, key1)
#<---
