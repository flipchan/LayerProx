...
def parse_conf():
	...
	conf_["crypt.serverkey"] = confparser.get('crypt', 'serverkey')
 	conf_["crypt.gpgdir"] = confparser.get('crypt', 'gpgdir')
	...
	conf_["server.mysql_password"] = confparser.get('server', 'mysql_password')
	conf_["server.mysql_user"] = confparser.get('server', 'mysql_user')
